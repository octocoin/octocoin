#!/usr/bin/env python
#
# Use the raw transactions API to spend octocoins received on particular addresses,
...
#
# Assumes it will talk to a octocoind or OctoCoin-Qt running
# on localhost.
#
# Depends on jsonrpc
#
...
def read_octocoin_config(dbdir):
...
def main():
    ...
    parser.add_option("--from", dest="fromaddresses", default=None,
                      help="addresses to get octocoins from")
    parser.add_option("--to", dest="to", default=None,
                      help="address to get send octocoins to")
    ...
    config = read_octocoin_config(options.datadir)
