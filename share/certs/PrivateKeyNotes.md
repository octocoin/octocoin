...
allowing somebody to distribute a OctoCoin-Qt.app or octocoin-qt-setup.exe with a valid
...
that the octocoin-qt.exe file inside the installer had not been tampered with.
