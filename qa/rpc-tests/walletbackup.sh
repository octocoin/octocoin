...
B4ARGS="-datadir=$D4"
$OCTOCOIND $OCTOCOINDARGS $B4ARGS &
B4PID=$!
...
B3ARGS="-datadir=$D3"
$OCTOCOIND $OCTOCOINDARGS $B3ARGS &
B3PID=$!
...
function StartThree {
  $OCTOCOIND $OCTOCOINDARGS $B1ARGS &
  B1PID=$!
  $OCTOCOIND $OCTOCOINDARGS $B2ARGS &
  B2PID=$!
  $OCTOCOIND $OCTOCOINDARGS $B3ARGS &
  B3PID=$!
}
